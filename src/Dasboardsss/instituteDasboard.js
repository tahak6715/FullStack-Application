  ...
  return (
    ...
    sx: {
      backgroundColor: "rgba(30, 139, 195, 0.8)"
       ...
       <Routes>
        <Route path='/course_list' element={<CourceList/>}/>
        <Route path='/course_form' element={<CourseForm/>}/>
        <Route path='/result' element={<Reslutty/>}/>
        <Route path='/registrationn_control' element={<FormControl/>}/>
        ...
        <Route path='/quiz' element={<SendQuiz/>}/>
